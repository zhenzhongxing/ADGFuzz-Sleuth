...
#define SLEUTH_ENV_RESPATH "SLEUTH_RESPATH"
#define SLEUTH_DEFAULT_RESPATH "/tmp/sleuth_res_file"
#define EVOCATIO_DEFAULT_RESPATH "/tmp/cap_res_file"
#define EVOCATIO_DEFAULT_PERMISSION 0666
#define EVOCATIO_IDENTIFIER "@@"
#define EVOCATIO_STACK_FRAME_MAXNUM 3
#define SLEUTH_STACK_FRAME_MAXNUM 10
#define SLEUTH_SKIP_FRAME 5
#define EVOCATIO_PLZ_HELP_RESPATH 1
#define SLEUTH_PLZ_HELP_RESPATH 1
...
/* Environment variable used in target fuzzing */
#define TARGET_BB "__TARGET_BB_ID"
...
#define TARGET_SIZE 14
#define TARGET_MAP (1U << TARGET_SIZE)

/* Add by wei at 2023.7.26 */
#define LOWESTLEVEL 0xFFFF

#define MINIMAL_SWITCH_EXEC (2 * 50 * 1000U)
#define MAXIUM_SWITCH_TIME (8 * 60 * 1000U)
#define LOG_TIME (10 * 60 * 1000U)
