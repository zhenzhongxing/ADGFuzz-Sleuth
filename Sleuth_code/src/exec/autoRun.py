...
def main():
    ...
    # INITPOC must be a file, not a directory
    ...
    for i in range(1, ROUND + 1):
        sleuth_cmd = f"AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 timeout {TIME} {SLEUTH} -m none -i {INFILE} -o {OUTFILE}{i} -k {INITPOC} -- {EXE} {PARAM}"
